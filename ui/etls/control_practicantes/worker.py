...
from orquestadores.pipeline_control_practicantes_executor import PipelineControlPracticantesExecutor
...
class ControlPracticantesWorker(BaseETLWorker):
    ...
    def execute_etl(self) -> Dict:
        ...
        try:
            ...
            yaml_path = get_resource_path("orquestadores/pipeline_control_practicantes.yaml")
